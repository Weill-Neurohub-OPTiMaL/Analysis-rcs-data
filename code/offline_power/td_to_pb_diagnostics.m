...
%             frechet : (8,2) array containing Frechet distance between the
%                 measured Power Bands and offline estimates in the second
%                 column, and the same comparison between measured Power
%                 Bands and their signal mean in the first column as a null
%                 comparison.
%             r : (8,1) array containing Pearson correlation coefficient  
%                 between measured Power Bands and offline estimates
%             R2 : (8,1) array containing R2 between measured Power Bands
%                 and offline estimates
%             RMSE : (8,1) array containing RMSE between measured Power  
%                 Bands and offline estimates
%             percent_error : (8,1) array containing percent error between  
%                 measured Power Bands and offline estimates
%             mean_shift : (8,1) array containing mean shift between 
%                 measured Power Bands and offline estimates
%             value_range : (8,1) array containing the range of values in 
